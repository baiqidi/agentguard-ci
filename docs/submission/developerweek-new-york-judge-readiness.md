...
5. The DeveloperWeek-specific demo video is public and aligned to the broad enterprise-agent story.

## Current Risk Register

| Risk | Status | Mitigation |
| --- | --- | --- |
| Video does not match DeveloperWeek positioning | Fixed | Public DeveloperWeek-specific demo: https://youtu.be/RQFx5FuB3nY |
...
- [x] Use DeveloperWeek-specific video URL: `https://youtu.be/RQFx5FuB3nY`.
