    ...
    const copy =
      locale === "zh"
        ? {
            ...
            suiteLabel: "SIFT 场景",
            suiteValue: "5 条 IR 路线",
            suiteDetail: "磁盘持久化 · 认证日志 · 网络处置 · Windows 事件 · 内存进程树",
            coverageLabel: "自我纠错",
            coverageValue: "1 条明确纠错链",
            coverageDetail: "错误假设被降级，证据充分的结论被保留",
            deliveryLabel: "可复现材料",
            deliveryValue: "6 个本地 artifact",
            deliveryDetail: "执行日志 · 准确性报告 · 数据集说明 · 调查叙事 · 评委摘要",
            verifyLabel: "评委能验证什么",
            verifyTitle: "每个 finding 都能追到 artifact locator。",
            verifyBody: "不是让评委相信旁白，而是让评委打开文件、offset、日志行或 flow id 自己复核。",
            verifyFoot: "agent-execution-log.jsonl · accuracy-report.json · judge-evidence-summary.md",
        ...
        : {
            ...
            suiteValue: "5 IR routes",
            suiteDetail: "disk persistence · auth logs · containment · Windows events · memory triage",
            ...
            deliveryValue: "6 local artifacts",
            deliveryDetail: "execution log · accuracy report · dataset docs · narrative · judge summary",
